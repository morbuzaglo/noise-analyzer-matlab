...
%METEOROLOGICALCORRECTION Long-term meteorological correction, ISO 9613-2:2024 eqs.(31)-(32)
%   (= ISO 9613-2:1996 eqs.(21)-(22), unchanged), for a point source with effectively
%   time-constant output. C0 depends on local meteorological
